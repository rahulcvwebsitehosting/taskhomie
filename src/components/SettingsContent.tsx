          ...
          {apiKeys && (
            <>
              ...
              <ApiKeyRow
                ...
                isSet={apiKeys.nvidia}
                onSave={(key) => handleSaveApiKey("nvidia", key)}
              />
              <ApiKeyRow
                label="OpenRouter (Free Models)"
                isSet={apiKeys.openrouter}
                onSave={(key) => handleSaveApiKey("openrouter", key)}
              />
              <ApiKeyRow
                label="Mistral (Free Tier)"
                isSet={apiKeys.mistral}
                onSave={(key) => handleSaveApiKey("mistral", key)}
              />
              <ApiKeyRow
                label="Google Gemini (Free)"
                isSet={apiKeys.gemini}
              ...
              <ApiKeyRow
                label="Cerebras (Free)"
                isSet={apiKeys.cerebras}
                onSave={(key) => handleSaveApiKey("cerebras", key)}
              />
              <ApiKeyRow
                label="Together AI"
                isSet={apiKeys.together}
                onSave={(key) => handleSaveApiKey("together", key)}
              />
              <ApiKeyRow
                label="DeepSeek"
                isSet={apiKeys.deepseek}
                onSave={(key) => handleSaveApiKey("deepseek", key)}
              />
              <ApiKeyRow
                label="OpenCode Zen (Free)"
                isSet={apiKeys.opencodeZen}
                onSave={(key) => handleSaveApiKey("opencode-zen", key)}
              />
              <ApiKeyRow
