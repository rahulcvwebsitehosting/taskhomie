...
import { ChatMessage, ConversationMeta, Conversation, ModelId, ProviderId, AgentMode } from "../types";
import {
  Send,
  Square,
  MousePointer2,
...
const PROVIDERS: Provider[] = [
  {
    ...
    name: "Anthropic",
    models: [
      { id: "claude-haiku-4-5-20251001", label: "Haiku 4.5", free: false },
      { id: "claude-sonnet-4-5", label: "Sonnet 4.5", free: false },
      { id: "claude-opus-4-5", label: "Opus 4.5", free: false },
    ],
  },
  {
    id: "nvidia",
    name: "Nvidia NIM",
    models: [
      { id: "deepseek-ai/deepseek-v4-pro", label: "DeepSeek V4 Pro", free: true },
      { id: "nvidia/llama-3.3-70b-instruct", label: "Llama 3.3 70B", free: true },
      { id: "nvidia/llama-3.1-405b-instruct", label: "Llama 3.1 405B", free: true },
      { id: "zhipuai/glm-4", label: "GLM-4", free: true },
      { id: "meta/llama-3.1-8b-instruct", label: "Llama 3.1 8B", free: true },
      { id: "mistralai/mistral-large-2-instruct", label: "Mistral Large 2", free: true },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "open-mixtral-8x22b", label: "Mixtral 8x22B", free: true },
      { id: "open-mixtral-8x7b", label: "Mixtral 8x7B", free: true },
    ],
  },
  {
    id: "gemini",
    ...
    models: [
      ...
      { id: "gemma-3-27b-it", label: "Gemma 3 27B", free: true },
    ],
  },
  {
    id: "groq",
    ...
    models: [
      ...
      { id: "llama-4-scout-17b-16e-instruct", label: "Llama 4 Scout", free: true },
      { id: "qwen-qwq-32b", label: "QwQ 32B", free: true },
  ...
  },
  {
    ...
    name: "Together AI",
    models: [
      { id: "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo", label: "Llama 3.1 70B Turbo", free: false },
      ...
      { id: "Qwen/Qwen2.5-72B-Instruct-Turbo", label: "Qwen 2.5 72B Turbo", free: false },
      { id: "deepseek-ai/DeepSeek-V3", label: "DeepSeek V3", free: false },
    ],
  },
  {
    id: "deepseek",
  ...
  },
  {
    ...
    name: "OpenCode Zen",
    models: [
      { id: "zen-1", label: "Zen 1", free: true },
    ],
  },
];
...
export default function ChatView({ variant, settingsOpen: propSettingsOpen, onSettingsClose, onCollapse }: ChatViewProps) {
  const { messages, isRunning, inputText, setInputText, selectedModel, setSelectedModel, selectedProvider, setSelectedProvider, selectedMode, setSelectedMode, streamingText, streamingThinking, clearMessages, setMessages, setVoiceMode, setConversationId } = useAgentStore();
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (provider && provider.models.length > 0) {
                      setSelectedModel(provider.models[0].id as ModelId);
                    }
                  }}
                  disabled={isRunning}
